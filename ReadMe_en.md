...
🌐 [AutoDL 镜像](https://www.codewithgpu.com/i/6llm/NLG-Chat/NLG-Chat) 中 `v11` 版本所使用代码已更新至本项目 `v0.2.7` 版本。
...
```
🧩 本项目有一个非常完整的[Wiki](https://github.com/6llm/NLG-Chat/wiki/) ， README只是一个简单的介绍，__仅仅是入门教程，能够基础运行__。 如果你想要更深入的了解本项目，或者想对本项目做出贡献。请移步 [Wiki](https://github.com/6llm/NLG-Chat/wiki/)  界面
...
支持列表详见[Wiki](https://github.com/6llm/NLG-Chat/wiki/)
...
```shell
# 拉取仓库
$ git clone https://github.com/6llm/NLG-Chat.git
# 进入目录
$ cd NLG-Chat
# 安装全部依赖
```
...
![](img/2fastapi_docs_026.png)

2. Web UI 启动界面示例：

- Web UI 对话界面：

![img](img/2LLM_success.png)

- Web UI 知识库管理页面：

![](img/2init_knowledge_base.jpg)

### 注意

以上方式只是为了快速上手，如果需要更多的功能和自定义启动方式 ，请参考[Wiki](https://github.com/6llm/NLG-Chat/wiki/)
...
## 联系我们
### Telegram
[![Telegram](https://img.shields.io/2badge/Telegram-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white "langchain-chatglm")](https://t.me/+RjliQ3jnJ1YyN2E9)

### 项目交流群
<img src="img/2qr_code_85.jpg" alt="二维码" width="300" />

🎉 NLG-Chat 项目微信交流群，如果你也对本项目感兴趣，欢迎加入群聊参与讨论交流。

### 公众号

<img src="img/2official_wechat_mp_account.png" alt="二维码" width="300" />

🎉 NLG-Chat 项目官方公众号，欢迎扫码关注。
https://docs.streamlit.io/library/2api-reference/chat
